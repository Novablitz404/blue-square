...
export function ActivityTracker({ activeTab, setActiveTab }: ActivityTrackerProps) {
  ...
  const getLevel = (points: number) => {
    if (points >= 1000) return { level: "Diamond", color: "text-purple-500", nextLevel: null, progress: 100 };
    if (points >= 500) return { level: "Platinum", color: "text-blue-500", nextLevel: "Diamond", progress: Math.min(((points - 500) / 500) * 100, 100) };
    if (points >= 200) return { level: "Gold", color: "text-yellow-500", nextLevel: "Platinum", progress: Math.min(((points - 200) / 300) * 100, 100) };
    if (points >= 100) return { level: "Silver", color: "text-gray-400", nextLevel: "Gold", progress: Math.min(((points - 100) / 100) * 100, 100) };
    if (points >= 50) return { level: "Bronze", color: "text-orange-500", nextLevel: "Silver", progress: Math.min(((points - 50) / 50) * 100, 100) };
    return { level: "Newbie", color: "text-green-500", nextLevel: "Bronze", progress: Math.min((points / 50) * 100, 100) };
  };
